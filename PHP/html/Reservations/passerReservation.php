...
<body>
    ...
    <form action="save-reservation.php" methode="POST">
        <div class="form-group">
            
            <div class="reservation-form">
                <div class="row">
                    <div class="col s12 m10 offset-m1 z-depth-2 backform">
                        ...
                        <div class="input-field col s3">
                            ...
                            <input type="text" class="datepicker" placeholder="Date de départ">
                        </div>

                        <div class="input-field col s3">
                            <i class="material-icons prefix">date_range</i>
                            <input type="text" class="datepicker" placeholder="Date de retour">
                        </div>
...
<body>
	...
	<div class="col-md-6 well">
		<h3 class="text-primary">PHP - Insert Data to SQLite Using PDO</h3>
